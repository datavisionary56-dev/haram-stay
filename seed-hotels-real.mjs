...
// Real Images from Wikimedia & Unsplash (Makkah Specific)
const abrajAlBait = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Abraj_Al_Bait_Towers.JPG/1280px-Abraj_Al_Bait_Towers.JPG";
const jabalOmar = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Jabal_Omar_Development_Project.jpg/1280px-Jabal_Omar_Development_Project.jpg";
const kaabaView = "https://images.unsplash.com/photo-1531303435785-3c5310c69135?auto=format&fit=crop&w=1280&q=80";
const makkahStreet = "https://images.unsplash.com/photo-1580418425653-5c17d7808925?auto=format&fit=crop&w=1280&q=80";
const makkahCity = "https://images.unsplash.com/photo-1565056637389-9134a9e52c8c?auto=format&fit=crop&w=1280&q=80";
const luxuryInterior = "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=1280&q=80";
const standardRoom = "https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&w=1280&q=80";
...
const hotels = [
  // 1. Front Row / Luxury (5 Hotels)
  {
    ...
    lat: 21.4198,
    lng: 39.8253,
    images: [abrajAlBait, luxuryInterior, kaabaView],
    stars: 5,
    price: 850,
    price1to20: 850,
  ...
  },
  {
    ...
    lat: 21.4207,
    lng: 39.8239,
    images: ["https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Makkah_Royal_Clock_Tower_Hotel.jpg/800px-Makkah_Royal_Clock_Tower_Hotel.jpg", luxuryInterior, makkahCity],
    stars: 5,
    price: 750,
    price1to20: 750,
  ...
  },
  {
    ...
    lat: 21.4196,
    lng: 39.8247,
    images: [abrajAlBait, "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&w=1280&q=80", kaabaView],
    stars: 5,
    price: 900,
    price1to20: 900,
  ...
  },
  {
    ...
    lat: 21.4233,
    lng: 39.8213,
    images: ["https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Jabal_Omar.jpg/1280px-Jabal_Omar.jpg", luxuryInterior, makkahCity],
    stars: 5,
    price: 950,
    price1to20: 950,
  ...
  },
  {
    ...
    lat: 21.4214,
    lng: 39.8222,
    images: ["https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Jabal_Omar_Makkah.jpg/1024px-Jabal_Omar_Makkah.jpg", luxuryInterior, kaabaView],
    stars: 5,
    price: 880,
    price1to20: 880,
  ...
  // 2. Ibrahim Al Khalil St (< 600m) (5 Hotels)
  {
    ...
    lat: 21.4150,
    lng: 39.8210,
    images: ["https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahStreet],
    stars: 5,
    price: 450,
    price1to20: 450,
  ...
  },
  {
    ...
    lat: 21.4120,
    lng: 39.8200,
    images: ["https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahCity],
    stars: 4,
    price: 300,
    price1to20: 300,
  ...
  },
  {
    ...
    lat: 21.4100,
    lng: 39.8190,
    images: ["https://images.unsplash.com/photo-1560185127-6ed189bf02f4?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahStreet],
    stars: 3,
    price: 200,
    price1to20: 200,
  ...
  },
  {
    ...
    lat: 21.4080,
    lng: 39.8180,
    images: ["https://images.unsplash.com/photo-1551524164-687a55dd1126?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahCity],
    stars: 3,
    price: 180,
    price1to20: 180,
  ...
  },
  {
    ...
    lat: 21.4200,
    lng: 39.8280, 
    images: [luxuryInterior, kaabaView, makkahCity],
    stars: 5,
    price: 600,
    price1to20: 600,
  ...
  // 3. Ajyad Street (< 600m) (5 Hotels)
  {
    ...
    lat: 21.4180,
    lng: 39.8280,
    images: ["https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1280&q=80", luxuryInterior, makkahStreet],
    stars: 5,
    price: 550,
    price1to20: 550,
  ...
  },
  {
    ...
    lat: 21.4160,
    lng: 39.8290,
    images: ["https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahCity],
    stars: 3,
    price: 250,
    price1to20: 250,
  ...
  },
  {
    ...
    lat: 21.4190,
    lng: 39.8270,
    images: ["https://images.unsplash.com/photo-1578895210405-927510122d6e?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahStreet],
    stars: 4,
    price: 400,
    price1to20: 400,
  ...
  },
  {
    ...
    lat: 21.4170,
    lng: 39.8285,
    images: ["https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1280&q=80", standardRoom, makkahCity],
    stars: 4,
    price: 350,
    price1to20: 350,
...
async function seedHotels() {
  console.log("🚀 Starting to clear and re-seed hotels with REALISTIC images...");
  ...
  console.log("🎉 Re-Seeding completed with real/official images!");
}
